...
export default class ChatGPTClient {
    ...
    setOptions(options) {
        ...
        this.modelOptions = {
            ...
            top_p:
                typeof modelOptions.top_p === "undefined"
                    ? 1
                    : modelOptions.top_p,
            presence_penalty:
...
||>Title:`,
    ...
    async sendMessage(message, opts = {}) {
        ...
        const shouldGenerateTitle =
            opts.shouldGenerateTitle && isNewConversation;
        ...
        if (shouldGenerateTitle) {
            conversation.title = await this.generateTitle(
                userMessage,
                replyMessage
            );
    ...
    async buildPrompt(messages, parentMessageId, isChatGptModel = false) {
        ...
        if (isChatGptModel) {
            ...
            currentTokenCount = this.getTokenCount(
